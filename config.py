...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003174131994")) #Your db channel Id
OWNER = os.environ.get("OWNER", "DhairyaXbh") # Owner username without @
...
DB_NAME = os.environ.get("DATABASE_NAME", "Dhairya's db")
#--------------------------------------------
FSUB_LINK_EXPIRY = int(os.getenv("FSUB_LINK_EXPIRY", "0"))  # 0 means no expiry
BAN_SUPPORT = os.environ.get("BAN_SUPPORT", "https://t.me/DhairyaXbh")
...
# --- HELP MESSAGE ---
HELP_TXT = "<b><blockquote>ᴛʜɪs ɪs ᴛʜᴇ ᴏғғɪᴄɪᴀʟ ʜᴇʟᴘ ᴅᴏᴄᴜᴍᴇɴᴛ ғᴏʀ ᴛʜᴇ ɪɴᴅɪᴀɴ ᴏsɪɴᴛ ʟᴏᴏᴋᴜᴘ ʙᴏᴛ, ᴘᴏᴡᴇʀᴇᴅ ʙʏ <a href='https://t.me/DhairyaXbh'>sᴀʏx𝐬ᴇᴇ.xʏᴢ</a>.\n\n❏ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅs\n├/start : ʀᴇsᴛᴀʀᴛs ᴛʜᴇ ʙᴏᴛ ᴀɴᴅ ᴄʜᴇᴄᴋs ғsᴜʙ\n├/myplan : ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴘʀᴇᴍɪᴜᴍ sᴛᴀᴛᴜs\n├/credits : sʜᴏᴡs ʏᴏᴜʀ ʀᴇᴍᴀɪɴɪɴɢ ғʀᴇᴇ ᴛʀɪᴇs\n├/referral : ɢᴇᴛ ʏᴏᴜʀ ʀᴇғᴇʀʀᴀʟ ʟɪɴᴋ\n├/about : ɢᴇᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ɪɴғᴏ\n└/help : ʏᴏᴜ ᴀʀᴇ ʜᴇʀᴇ\n\nsɪᴍᴘʟʏ sᴇɴᴅ ᴀɴ ɪɴᴅɪᴀɴ ɴᴜᴍʙᴇʀ (ᴇ.ɢ., +91...) ᴛᴏ ʙᴇɢɪɴ ʏᴏᴜʀ sᴇᴀʀᴄʜ.\n\nғᴏʀ sᴜᴘᴘᴏʀᴛ: ᴄᴏɴᴛᴀᴄᴛ ᴏᴜʀ sᴜᴘᴘᴏʀᴛ ʙᴏᴛ <a href='https://t.me/DhairyaXbh'>@Connect_SayXSee_Bot</a></blockquote></b>"

# --- ABOUT MESSAGE (U+200B cleaned) ---
ABOUT_TXT = "<b><blockquote>◈ ᴅᴇᴠᴇʟᴏᴘᴇᴅ & ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ: <a href='https://t.me/DhairyaXbh</a>\n◈ ᴏғғɪᴄɪᴀʟ ᴛᴇʟᴇɢʀᴀᴍ ᴄʜᴀɴɴᴇʟ: <a href='https://t.me/+10TQd-BMf3I0MjM1'>sᴀʏx𝐬ᴇᴇ ᴄʜᴀɴɴᴇʟ</a>\n◈ ᴏғғɪᴄɪᴀʟ sᴜᴘᴘᴏʀᴛ ʙᴏᴛ: <a href='https://t.me/Dhairya_contact_Bot'>@Connect_SayXSee_Bot</a>\n◈ sᴜᴘᴘᴏʀᴛ ᴘᴀɢᴇ: <a href='https://t.me/Dhairya_bh</a>\n\nᴛʜɪs ʙᴏᴛ ᴘʀᴏᴠɪᴅᴇs ᴏsɪɴᴛ ᴅᴀᴛᴀ ʟᴏᴏᴋᴜᴘs ʙᴀsᴇᴅ ᴏɴ ᴀᴄᴄᴇssᴇᴅ ᴅᴀᴛᴀsᴇᴛs.</blockquote></b>"
#--------------------------------------------
...
"""
#--------------------------------------------
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @DhairyaXbh</b>") #set your Custom Caption here, Keep None for Disable Custom Caption
